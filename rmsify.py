...
unknowns = {''}
ln = 1
files = ['main.c', 'shared.c', 'relics.c', 'setup.c', 'dataLoad.c', 'npc.c', 'chooseClass.c', 'gameplayHelpers.c', 'traps.c', 'buildMap.c', 'moonblade.c', 'sunbow.c', 'enemies.c', 'bosses.c', 'gameplay.c']
first = True
try:
