...
code("setupClass(\"Royal Guard Hero\", THUNDERCALLER, 600, 1000, 6);");
...
code("}");
code("}");
code("angle = trQuestVarGet(\"p\"+p+\"health\") * trQuestVarGet(\"p\"+p+\"spellDamage\") * 0.03;");
...
code("trUnitDestroy();");
code("trQuestVarSet(\"crescentStarted\", 1);");
...
code("if ((trQuestVarGet(\"crescentStarted\") == 1) && (trQuestVarGet(\"spyFind\") == trQuestVarGet(\"spyFound\"))) {");
code("for(x=yGetDatabaseCount(\"p\"+p+\"characters\"); >0) {");
code("yDatabaseNext(\"p\"+p+\"characters\");");
code("if (yGetVar(\"p\"+p+\"characters\", \"crescentSFX\") < 0) {");
...
code("}");
code("trQuestVarSet(\"crescentStarted\", 0);");
code("}");
