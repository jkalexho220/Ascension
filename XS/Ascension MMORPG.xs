...
code("trOverlayText(\"The Seekers Project\", 3.0, -1, -1, -1);");
...
code("if (class > 16) {");
code("next = 0;");
code("int revealed = ((class - 16) / 4) * 2;");
...
code("case POTION_STUN:");
code("{");
code("trSetCounterDisplay(\"Potion: STUN\");");
...
code("ySetVar(\"p\"+p+\"duplicates\", \"decay\", yGetVar(\"p\"+p+\"duplicates\") + calculateDecay(p, 1.0));");
