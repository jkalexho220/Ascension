...
code("savedata = savedata * 2 + trQuestVarGet(\"playerHasHosted\");");
...
code("trQuestVarSetFromRand(\"nottud\", 0, 20, true);");
code("if (trQuestVarGet(\"nottud\") < trQuestVarGet(\"stage\")) {");
...
code("}");
code("}");
code("} else if (trQuestVarGet(\"nottud\") > 0) {");
code("for(i=3; >0) {");
