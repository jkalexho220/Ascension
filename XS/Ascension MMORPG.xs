...
code("trChatSend(0, \"playerHasHosted \" + trQuestVarGet(\"playerHasHosted\"));");
code("trChatSend(0, \"bossKills \" + trQuestVarGet(\"bossKills\"));");
code("trChatSend(0, \"giantKills \" + trQuestVarGet(\"giantKills\"));");
code("trChatSend(0, \"questCount \" + trQuestVarGet(\"questCount\"));");
code("trChatSend(0, \"zenoQuiz \" + trQuestVarGet(\"zenoQuiz\"));");
...
code("int proto = 0;");
code("for(p=1; < ENEMY_PLAYER) {");
code("trModifyProtounit(\"Villager Atlantean Hero\", p, 5, trQuestVarGet(\"p\"+p+\"transporterLevel\"));");
...
code("case 2:");
code("{");
code("uiMessageBox(\"I can carry up to \"+(3+trQuestVarGet(\"p\"+trCurrentPlayer()+\"transporterLevel\"))+\" relics.\");");
code("}");
code("case 3:");
code("{");
code("uiMessageBox(\"When you clear this floor, any relics I carry will be sent to your warehouse.\");");
code("}");
code("case 4:");
code("{");
...
code("{");
code("icon = \"icons\god power pestilence icon 64\";");
code("msg = \"Damage: 12 | Duration: 12\";");
code("}");
code("case 5:");
code("{");
code("icon = \"icons\god power restoration icon 64\";");
...
code("}");
code("trQuestVarSet(\"pad1\", 0);");
code("trQuestVarSet(\"pad2\", 0);");
code("trVectorQuestVarSet(\"pos1\", kbGetBlockPosition(\"\"+1*yGetVar(\"chests\", \"pad1\")));");
code("trVectorQuestVarSet(\"pos2\", kbGetBlockPosition(\"\"+1*yGetVar(\"chests\", \"pad2\")));");
code("for(x=yGetDatabaseCount(\"playerUnits\"); >0) {");
code("id = yDatabaseNext(\"playeRUnits\", true);");
code("if (id == -1 || trUnitAlive() == false) {");
code("removeChest();");
code("} else if (zDistanceToVectorSquared(\"playerUnits\", \"pad1\") < 0.7) {");
code("trQuestVarSet(\"pad1\", 1);");
code("} else if (zDistanceToVectorSquared(\"playerUnits\", \"pad2\") < 0.7) {");
code("trQuestVarSet(\"pad2\", 1);");
code("}");
code("if (trQuestVarGet(\"pad1\") * trQuestVarGet(\"pad2\") == 1) {");
code("ySetVar(\"chests\", \"state\", CHEST_STATE_UNLOCKED);");
code("break;");
code("}");
code("}");
...
code("{");
code("int size = trQuestVarGet(\"bossRoomSize\");");
code("z0 = size;");
code("for(a=0; < size) {");
code("for(b=size; >0) {");
...
code("trQuestVarSet(\"extraEdges\", 10);");
code("TERRAIN_WALL = 2;");
...
code("trModifyProtounit(\"King Folstag\", ENEMY_PLAYER, 1, 2.15);");
...
code("removeEnemy();");
code("} else if (zDistanceToVectorSquared(\"enemies\", \"pos\") < 16) {");
code("poisonUnit(\"enemies\", 12,12, p);");
code("}");
code("}");
code("}");
code("}");
...
code("target = yGetVar(\"p\"+p+\"characters\", \"attackTarget\");");
code("for(x=yGetDatabaseCount(\"enemies\"); >0) {");
code("if (target == yDatabaseNext(\"enemies\", true)) {");
code("stunUnit(\"enemies\", 1.5, p);");
code("}");
code("}");
code("}");
...
code("6,trQuestVarGet(\"icicleRadius\") * trQuestVarGet(\"p\"+p+\"spellRange\"));");
...
code("spyEffect(1*trQuestVarGet(\"enemiesIncoming\"), kbGetProtoUnitID(\"UI Range Indicator Norse SFX\"), \"fake\");");
code("}");
...
code("vectorSetAsTargetVector(\"target\", \"start\", \"end\");");
...
code("yAddUpdateVar(\"ballistaShots\", \"timeout\", trTimeMS() + 10000);");
...
code("case THUNDERRIDER:");
code("{");
code("if (trQuestVarGet(\"giantKills\") >= 50) {");
code("unlocked = true;");
code("}");
code("}");
code("}");
...
code("case THUNDERRIDER:");
code("{");
code("uiMessageBox(\"To unlock this class, kill 50 Giants. Current: \" + 1*trQuestVarGet(\"giantKills\"));");
code("}");
code("case FIREKNIGHT:");
code("{");
...
code("setupExplain(\"Next Question: Each cooldown reduction relic grants 0.1x cooldown reduction.\");");
