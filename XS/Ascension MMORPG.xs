...
code("trChatSend(0, \"<color=1,0,0>\"+db+\" is pointing to something wrong!\");");
code("}");
code("}");
...
code("const int RELIC_WEIGHTED_BLOWS = 21;");
code("const int RELIC_YEEBAAGOOON = 22;");
code("const int RELIC_ZENOPHOBIA = 23;");
code("const int RELIC_NICKONHAWK = 24;");
code("const int RELIC_NOTTUD = 25;");
...
code("const int RELIC_ON_ATTACK = 30;");
...
code("{");
code("msg = \"+0.5x damage to stunned enemies.\";");
code("}");
code("case RELIC_ALL:");
code("{");
code("msg = \"Spell Power, Duration, Range +0.1\";");
code("}");
...
code("case RELIC_STUN_KILLER:");
code("{");
code("trQuestVarSet(\"p\"+p+\"stunKiller\", trQuestVarGet(\"p\"+p+\"stunKiller\") + 0.5 * m);");
code("}");
code("case RELIC_ALL:");
code("{");
code("trQuestVarSet(\"p\"+p+\"spellDamage\", trQuestVarGet(\"p\"+p+\"spellDamage\") + 0.1 * m);");
code("trQuestVarSet(\"p\"+p+\"spellDuration\", trQuestVarGet(\"p\"+p+\"spellDuration\") + 0.1 * m);");
code("trQuestVarSet(\"p\"+p+\"spellRange\", trQuestVarGet(\"p\"+p+\"spellRange\") + 0.1 * m);");
code("}");
code("case RELIC_ULTIMATE_COST:");
code("{");
...
code("trQuestVarSet(\"p\"+p+\"stunKiller\", 1);");
code("trQuestVarSet(\"p\"+p+\"poisonKiller\", 1);");
...
code("setupClass(\"Archer Atlantean Hero\", STORMCUTTER, 400, 1000, SOULSTONE);");
...
code("savedata = trPlayerResourceCount(p, \"Gold\") - trQuestVarGet(\"p\"+p+\"gold\");");
...
code("uiMessageBox(\"Welcome to the Seeker's Guild! There are many things you can do here!\");");
code("}");
code("case 2:");
code("{");
...
code("{");
code("icon = \"icons\god power eclipse icon 64\";");
code("msg = \"Cooldown: 18 | Duration: 6 | Radius: 6 | Damage: 30 + 15 per ally\";");
code("next = 4;");
code("}");
code("case 7:");
code("{");
...
code("{");
code("icon = \"icons\special e phoenix icon 64\";");
code("msg = \"Cooldown: 12 | Radius: 4 | Damage: 90\";");
code("}");
code("case 5:");
code("{");
...
code("case 1:");
code("{");
code("msg = \"Passive: Each time you stun an enemy, restore 5 pecent of your health.\";");
code("}");
code("case 2:");
code("{");
...
code("{");
code("icon = \"icons\god power pestilence icon 64\";");
code("msg = \"Duration: 12 | Damage: 12 x Projectiles\";");
code("}");
code("case 5:");
code("{");
code("icon = \"icons\god power restoration icon 64\";");
...
code("const int ON_HIT_ATTACKING = 1;");
code("const int ON_HIT_NORMAL = 2;");
code("const int ON_HIT_SPECIAL = 3;");
...
code("trUnitSelectClear();");
code("trUnitSelectByQV(\"p\"+p+\"unit\");");
code("healUnit(p, 0.05 * trQuestVarGet(\"p\"+p+\"health\"), 1*trQuestVarGet(\"p\"+p+\"index\"));");
code("trUnitSelectClear();");
...
code("if (xsAbs(yGetVar(\"p\"+p+\"characters\", \"attackTarget\") - target) > 0) {");
code("ySetVar(\"p\"+p+\"characters\", \"attackNext\", trTimeMS() + trQuestVarGet(\"p\"+p+\"firstDelay\"));");
...
code("highFrequency");
code("{");
code("if (xsAbs(trQuestVarGet(\"spyfound\") - trQuestVarGet(\"spyfind\")) > 0) {");
...
code("trVectorSetUnitPos(\"spos\", \"spysearch\");");
code("while(true) {");
code("trUnitSelectClear();");
code("trUnitSelectByQV(\"spyEye\"+x+\"unit\");");
code("if (trUnitAlive() == false) {");
code("trQuestVarSet(trStringQuestVarGet(\"spyName\"+x), -1);");
code("} else if (zDistanceToVectorSquared(\"spyEye\"+x+\"unit\", \"spos\") > 0.7) {");
code("trQuestVarSet(trStringQuestVarGet(\"spyName\"+x), -1);");
code("} else {");
code("trUnitSelectClear();");
...
code("break;");
code("}");
code("if (trQuestVarGet(\"spyFound\") - trQuestVarGet(\"spyFind\") == 0) {");
code("break;");
code("}");
...
code("trQuestVarSet(\"spysearch\", trGetNextUnitScenarioNameNumber() - 1);");
code("}");
code("}");
...
code("if ((yGetVar(\"unlockWalls\", \"posX\") - yGetVar(\"unlockWalls\", \"xMod\") - 6 < trQuestVarGet(\"posX\")) &&");
code("(yGetVar(\"unlockWalls\", \"posX\") + yGetVar(\"unlockWalls\", \"xMod\") + 6 > trQuestVarGet(\"posX\")) &&");
code("(yGetVar(\"unlockWalls\", \"posZ\") - yGetVar(\"unlockWalls\", \"zMod\") - 6 < trQuestVarGet(\"posZ\")) &&");
code("(yGetVar(\"unlockWalls\", \"posZ\") + yGetVar(\"unlockWalls\", \"zMod\") + 6 > trQuestVarGet(\"posZ\"))) {");
...
code("trPaintTerrain(x0-1,z0-1,x1+1,z1+1,TERRAIN_PRIMARY,TERRAIN_SUB_PRIMARY,true);");
...
code("trSetUnitOrientation(trVectorQuestVarGet(\"dir\"),vector(0,1,0),true);");
code("trChatSend(0, \"correctStatues is \"+ 1*trQuestVarGet(\"correctStatuesIn\"+room));");
code("}");
code("}");
code("}");
...
code("void deployEyecandy(string proto = \"\", int x = 0, int z = 0, int heading = 0) {");
...
code("trQuestVarSet(\"chestType\", CHEST_STATUES);");
...
code("deployEyecandy(\"Savannah Tree\",15,37,0);");
code("deployEyecandy(\"Savannah Tree\",11,33,50);");
code("deployEyecandy(\"Savannah Tree\",5,21,90);");
code("deployEyecandy(\"Savannah Tree\",29,31,47);");
code("deployEyecandy(\"Savannah Tree\",33,29,127);");

code("deployEyecandy(\"House\",7,29,180);");
code("deployEyecandy(\"House\",9,15,0);");

code("deployEyecandy(\"Granary\",7,33,0);");
code("deployEyecandy(\"Dock\",9,13,0);");
code("deployEyecandy(\"Tower\",33,15,270);");
code("deployEyecandy(\"Counter Building\",23,29,180);");

code("deployEyecandy(\"Fence Wood\",19,15,180);");
code("deployEyecandy(\"Fence Wood\",19,11,180);");
code("deployEyecandy(\"Fence Wood\",21,9,270);");
code("deployEyecandy(\"Fence Wood\",25,17,270);");
code("deployEyecandy(\"Fence Wood\",27,15,180);");
code("deployEyecandy(\"Fence Wood\",27,11,180);");
code("}");
...
code("{");
code("trPaintTerrain(x*35+20-size,z*35+20-size,x*35+34,z*35+20+size, TERRAIN_PRIMARY, TERRAIN_SUB_PRIMARY, false);");
code("trChangeTerrainHeight(x*35+20-size,z*35+20-size,x*35+21+size,z*35+20+size, worldHeight, false);");
code("}");
code("}");
...
code("if (xsAbs(x0 + 4 * z0 - trQuestVarGet(\"village\")) > 0) {");
code("buildRoom(x0, z0, ROOM_BASIC);");
code("}");
code("if (xsAbs(x1 + 4 * z1 - trQuestVarGet(\"village\")) > 0) {");
...
code("trModifyProtounit(\"King Folstag\", ENEMY_PLAYER, 0, -9999999999999999999.0);");
code("trModifyProtounit(\"King Folstag\", ENEMY_PLAYER, 0, 12000 * ENEMY_PLAYER);");
...
code("}");
code("if (trQuestVarGet(\"frontier\") < 15 && xsAbs(trQuestVarGet(\"frontier\") - trQuestVarGet(\"village\")) > 0) {");
code("for(a=1; >=0) {");
code("for(b=1; >=0) {");
code("trQuestVarSet(\"newX\", (1 - 2 * b) * a + x);");
code("trQuestVarSet(\"newZ\", (1 - 2 * b) * (1 - a) + z);");
...
code("}");
code("}");
code("if ((trQuestVarGet(\"mapType\") == MAP_PORTALS) && (edgeIsPortal == false)) {");
code("trQuestVarSetFromRand(\"rand\", 1, 14, true);");
code("n = trQuestVarGet(\"rand\");");
code("if (trQuestVarGet(\"tile\"+n) < TILE_VISITED && xsAbs(n - trQuestVarGet(\"villageEntrance\")) > 0) {");
...
code("for(i=0; <trQuestVarGet(\"extraEdges\")) {");
...
code("} else {");
code("n = 0 + trQuestVarGet(\"newX\") + 4 * trQuestVarGet(\"newZ\");");
code("if (xsAbs(trQuestVarGet(\"first\") - trQuestVarGet(\"village\")) * xsAbs(n - trQuestVarGet(\"village\")) > 0) {");
...
code("trQuestVarSetFromRand(\"relicTransporterGuy\", 1, 13, true);");
code("trQuestVarSet(\"relicTransporterGuy\", trQuestVarGet(\"village\") + trQuestVarGet(\"relicTransporterGuy\"));");
code("if (trQuestVarGet(\"relicTransporterGuy\") > 14) {");
code("trQuestVarSet(\"relicTransporterGuy\", trQuestVarGet(\"relicTransporterGuy\") - 14);");
code("}");
...
code("trQuestVarSet(\"chestRand\", 1);");
code("} else {");
...
code("for (x=trQuestVarGet(\"hawkStart\"); < trGetNextUnitScenarioNameNumber()) {");
code("if (kbGetUnitBaseTypeID(kbGetBlockID(\"\"+x)) == kbGetProtoUnitID(\"Hawk\")) {");
code("trUnitSelectClear();");
code("trUnitSelect(\"\"+x);");
code("trUnitChangeProtoUnit(\"Pegasus\");");
code("trUnitSelectClear();");
code("trUnitSelect(\"\"+x);");
code("trSetSelectedScale(30,30,30);");
code("}");
code("}");
...
code("trQuestVarSet(\"moonbeamDamage\", 30);");
code("trQuestVarSet(\"moonbeamDamageBoost\", 15);");
...
code("trQuestVarGet(\"class\"+SUNBOW+\"nextDelay\") * 3.0 / (2.0 + trQuestVarGet(\"p\"+p+\"projectiles\")));");
code("}");
...
code("trQuestVarSet(\"p\"+p+\"nextDelay\",");
code("trQuestVarGet(\"class\"+STORMCUTTER+\"nextDelay\") * 3.0 / (2.0 + trQuestVarGet(\"p\"+p+\"projectiles\")));");
...
code("if (trQuestVarGet(\"playerUnits\") == trQuestVarGet(\"p\"+1*yGetVar(\"playerUnits\", \"player\")+\"unit\")) {");
code("trQuestVarSet(\"p\"+1*yGetVar(\"playerUnits\", \"player\")+\"silencedTimeout\", 0);");
code("}");
...
code("if (yGetDatabaseCount(\"p\"+p+\"icicles\") > 0) {");
code("yDatabaseNext(\"p\"+p+\"icicles\", true);");
code("trQuestVarSet(\"scale\", (yGetVar(\"p\"+p+\"icicles\", \"timeout\") - trTimeMS()) / trQuestVarGet(\"icicleDuration\") / 1000);");
code("trQuestVarSet(\"scale\", 1.0 + 3.0 * trQuestVarGet(\"scale\"));");
code("if (trQuestVarGet(\"scale\") <= 1.0) {");
...
code("} else {");
code("trSetSelectedScale(yGetVar(\"p\"+p+\"icicles\", \"radius\"),trQuestVarGet(\"scale\"),yGetVar(\"p\"+p+\"icicles\", \"radius\"));");
code("}");
code("}");
...
code("trQuestVarGet(\"p\"+p+\"wellPosx\"),0,trQuestVarGet(\"p\"+p+\"wellPosz\"),trQuestVarGet(\"heading\"),true);");
...
code("yAddUpdateVar(\"p\"+p+\"icicles\", \"timeout\",");
code("trTimeMS() + 1000 * trQuestVarGet(\"icicleDuration\") * trQuestVarGet(\"p\"+p+\"spellDuration\"));");
...
code("3,trQuestVarGet(\"icicleRadius\") * trQuestVarGet(\"p\"+p+\"spellRange\"));");
code("trUnitHighlight(trQuestVarGet(\"icicleDuration\") * trQuestVarGet(\"p\"+p+\"spellDuration\"), false);");

code("trSoundPlayFN(\"piercemetal3.wav\", \"1\", -1, \"\", \"\");");
code("trSoundPlayFN(\"egg2.wav\", \"1\", -1, \"\", \"\");");
...
code("trQuestVarSet(\"blizzardDuration\", 6);");
code("trQuestVarSet(\"blizzardDamage\", 20);");
...
code("yAddUpdateVar(\"Medusa\", \"index\", yGetNewestPointer(\"enemies\"));");
code("}");
...
code("action = 0;");
code("for(p=1; < ENEMY_PLAYER) {");
code("action = action + trCountUnitsInArea(\"\"+1*trQuestVarGet(\"ballistaShots\"),p,\"Unit\",2.5);");
code("}");
code("if (action > 0) {");
code("ballistaShotPop();");
code("}");
...
code("trVectorQuestVarSet(\"dir\", zGetUnitVector(\"start\", \"end\"));");
code("addGenericProj(\"MedusaBalls\",\"start\",\"dir\",kbGetProtoUnitID(\"Curse SFX\"),2,5,5);");
...
code("if (trQuestVarGet(\"iceKingArmor\") == 1) {");
code("trSoundPlayFN(\"icemono.wav\",\"1\",-1,\"\",\"\");");
code("trSoundPlayFN(\"bronzebirth.wav\",\"1\",-1,\"\",\"\");");
code("trModifyProtounit(\"King Folstag\", ENEMY_PLAYER, 24, 1);");
code("trModifyProtounit(\"King Folstag\", ENEMY_PLAYER, 25, 1);");
...
code("trUnitSelectClear();");
code("trUnitSelectByQV(\"auroraSFX\");");
code("trUnitChangeProtoUnit(\"Vortex Finish Linked\");");
code("} else {");
code("spyEffect(1*trQuestVarGet(\"bossUnit\"), kbGetProtoUnitID(\"Vortex Finish Linked\"), \"auroraSFX\");");
code("}");
code("}");
code("bossCooldown(10, 15);");
code("} else if (yGetVarAtIndex(\"enemies\", \"stunStatus\", 1*trQuestVarGet(\"bossPointer\")) == 0) {");
...
code("if ((action == 11) && xsAbs(trQuestVarGet(\"p\"+p+\"action\") - 12) > 0) {");
code("trUnitSetAnimationPath(\"0,0,0,0,0,0,0\");");
...
code("case STARSEER:");
code("{");
code("if (trQuestVarGet(\"questCount\") >= 3) {");
code("unlocked = true;");
code("}");
code("}");
code("case INVENTOR:");
...
code("case STARSEER:");
code("{");
code("uiMessageBox(\"To unlock this class, complete three quests. Current: \" + 1*trQuestVarGet(\"questCount\"));");
code("}");
code("case STORMCUTTER:");
code("{");
...
code("{");
code("gem = MANASTONE;");
code("setupExplain(\"First Question: Each cooldown reduction relic grants 0.1x cooldown reduction.\");");
code("setupQuestion(\"If I have 10 cooldown reduction relics, how long are my cooldowns?\",");
code("\"Cooldowns are 0\", \"Cooldowns are 0.35x as long\", 2);");
...
code("setupQuestion(\"Only the strongest poison deals damage. Poison damage does not stack.\");");
