...
code("const int STORMCUTTER = 7;");

code("const int ALCHEMIST = 8;");
code("const int INVENTOR = 9;");

code("const int CLASS_COUNT = 7;");
...
code("if (trQuestVarGet(\"p\"+p+\"lureStatus\") == ABILITY_ON) {");
code("trQuestVarSet(\"p\"+p+\"lureStatus\", ABILITY_OFF);");
code("trPlayerGrantResources(p, \"gold\", trQuestVarGet(\"whirlwindCost\") * trQuestVarGet(\"p\"+p+\"ultimateCost\"));");
...
code("yAddUpdateVar(\"p\"+p+\"frostGiants\", \"decaynext\", trTimeMS());");
...
code("if (id == -1 || trUnitAlive() == false) {");
code("yRemoveFromDatabase(\"p\"+p+\"frostGiants\");");
code("} else if (trTimeMS() > yGetVar(\"p\"+p+\"frostGiants\", \"decaynext\")) {");
code("ySetVar(\"p\"+p+\"frostGiants\", \"decaynext\", trTimeMS() + 1000);");
code("damagePlayerUnit(calculateDecay(p, trQuestVarGet(\"frostGiantDecay\")), 1*yGetVar(\"p\"+p+\"frostGiants\", \"index\"));");
...
code("case STARSEER:");
code("{");
code("uiMessageBox(\"To unlock this class, complete three quests.\");");
code("}");
code("}");
code("}");
code("}");
